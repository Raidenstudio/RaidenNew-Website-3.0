...
const featureContent_service = [

    {
        ...
        description: "Integrate blockchain technology seamlessly to guarantee safe gameplay, ownership verification, and a reliable gaming environment."
    },
    {
        delayAnimation: "50",
        ...
        description: "Smart contracts that regulate in-game activities and transactions can help your game become more automated and transparent."
    },
    {
        delayAnimation: "100",
        ...
        description: "Create player-driven economies that allow users to produce, exchange, and possess assets, increasing long-term value and user engagement."
    },
    {
        delayAnimation: "150",
        ...
        description: "By enabling players to own, trade, and profit from exclusive in-game items, non-fungible tokens (NFTs) can improve gameplay."
    },
    {
        delayAnimation: "200",
        ...
        description: "Use decentralized networking protocols to link players worldwide and provide safe, smooth, and real-time multiplayer experiences."
    },
    {
        delayAnimation: "250",
        ...
        description: "Make your game compatible with a variety of blockchains and protocols to guarantee cross-platform scalability and performance."
    }
...
const FeatureContent = [
    {
        ...
        subTitle: "Giving players actual control over in-game items will allow you to reward their dedication, time, and money with real benefits.",
    },
    {
        icon: icon14,
        title: "Increased Monetization Opportunities",
        subTitle: "Use player-driven economies, in-game purchases, and NFTs to generate new revenue streams that are advantageous to both developers and players.",
    },
    {
        icon: icon15,
        title: "Community Engagement",
        subTitle: "Enable players to play, cooperate, and make money in a reliable ecosystem by encouraging safe and engaged community involvement.",
    },
    {
        icon: icon16,
        title: "Trust and Transparency",
        subTitle: "Blockchain can be used to guarantee secure data, transparent transactions, and unchangeable records that foster long-term player trust.",
    },
    {
        icon: icon17,
        title: "Innovative Gameplay Mechanics",
        subTitle: "Rethink the way games are played by using player-driven narratives and smart contracts to create decentralized, dynamic experiences.",
    },
    {
        icon: icon18,
        title: "Future Proofing",
        subTitle: "Position your game at the forefront of the market with innovative technology that will change as gaming does.",
    }
];
                ...
                <div className="row">
                    <div className="col-xl-11 col-lg-12 col-md-10 m-auto text-center">
                        <h1 style={{ fontSize: "70px", fontStyle: "Raleway", color: "white" }} className="hero-heading" data-aos="fade-up">
                            Leading the Evolution of <br /> Gaming
                            <span style={{ color: "#FF006B" }}> Through Web3</span>{" "}
                        ...
                        <div className="col-xl-8 col-lg-11 col-md-10 m-auto">
                            <div className="title-style-six text-center">
                                ...
                                <p className="text-xs text-white">
                                    Reliable proficiency in Web3 game development fueled by creativity, safety, and track records of accomplishment.
                                </p>
                            </div>
                            {/* /.title-style-six */}
                        </div>
