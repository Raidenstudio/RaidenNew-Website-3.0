  ...
  const benefits = [
    {
      name: "Empowerment",
      value:
        " Become the best version of yourself by continuously adjusting to social situations while feeling empowered and capable.",
      name2: " social skills",
      value2:
        " Strengthen your public speaking abilities by continuously practicing in our controlled environment.",
      name3: "Reduced Anxiety",
      value3:
        "Using techniques for gradual exposure and desensitization, you can overcome your anxiety related to uncomfortable social situations.",
    },
  ];
  ...
  const keyfeature = [
    {
      ...
      description:
        "Go beyond just imagining; visualize and feel through your eye view of your 2D architectural design.",
      name2: "Interactive Design Customization",
      description2:
        " Architecture is perfectly structured right from initial material selections to lighting configurations. Providing different options and making you visually explore your complete choices.",

      name5: " Pre-Construction Visualization ",
      description5:
        "Raiden creates VR and 3D models before construction starts, detecting and resolving possible problems to save time, avoid expensive mistakes and misinterpretations, and lower risks. ",

      name4: "Engage Marketing Solutions",
      description4:
        " Draw in prospective customers and investors by using virtual reality to showcase models and encourage interaction through immersive experiences.",
    },
  ];
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-5">
                <p className="md-pt-20">
                  Architecting your projects with the enhanced, future focused
                  innovation Virtual Reality (VR) technology. With its modern
                  hardware and software, Raiden offers creative services and
                  high-quality solutions to meet all real estate and
                  architectural needs.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="title-style-ten mb-40 md-mb-20">
            <div className="row align-items-center">
              ...
              <div className="col-lg-5">
                <p className="md-pt-20">
                  Employing virtual reality (VR) technology to revolutionize the
                  architecture and real estate sectors with passionate experts
                  who are advancing traditional design and visualization methods
                  and opening the door for a futuristic approach.
                </p>
              </div>
            </div>
          </div>
